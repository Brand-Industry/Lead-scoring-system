...
import { ChartResults, AccordiosResults, GenereteMessageDate, LoadingResults, NotFoundResults, GenereteDataPicker } from '../../partials';
    ...
    <div className="ResultsLeads mt-2">
      ...
      {dataSubmissions.length === 0 ? (
        ...
        <>
          ...
          <AccordiosResults dataSubmissions={dataSubmissions} totalRolesPoints={totalRolesPoints} />
        </>
      )}
    </div>
  );
